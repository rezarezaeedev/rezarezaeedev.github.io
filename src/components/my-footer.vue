    ...
    <footer class="bg-rezablack px-10 py-5 mt-28 flex flex-col"> 
        <div class="container desktop:px-20 desktop:mx-auto flex flex-col tablet:space-x-0 space-y-5 ">
            <div class="flex space-x-5 justify-center"> <!--Social media section-->
                <a :href="'https://www.linkedin.com/in/'+data.linkedin" rel="nofollow" target="_blank" class="text-rezawhite hover:scale-125 "> <!--LinkedIn-->
                ...
                <a :href="'https://instagram.com/'+data.instagram" rel="nofollow" target="_blank" class="text-rezawhite hover:scale-125 "> <!--instagram-->
                ...
                <a :href="'https://github.com/'+data.github" rel="nofollow" target="_blank" class="text-rezawhite hover:scale-125 "> <!--github-->
                ...
                <a :href="'https://t.me/'+data.telegram" rel="nofollow" target="_blank" class="text-rezawhite hover:scale-125 "> <!--telegram-->
            ...
            <div class="flex flex-col space-y-2"> <!--Call info section-->
                <div class="flex text-rezawhite items-center tablet:text-xl text-sm space-x-2 hover:text-rezaprimary" > <!--Phone number-->
                    ...
                    <a :href="'tel:'+data.phone" rel="nofollow">{{data.phone}}</a >
                </div>
